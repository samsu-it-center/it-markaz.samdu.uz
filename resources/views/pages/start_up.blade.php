    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <ul class="nav nav-pills justify-content-center " id="horizontalNavbar" role="tablist">
                <li class="nav-item">
                    <button
                        class="nav-link {{ request('tab') == 'home' || request('tab') == null ? 'active' : '' }} p-3 m-5 border-1 rounded-pill"
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="tab-content" id="horizontalNavbarContent">
                ...
                <!-- StartUplar tab -->
                <div class="tab-pane fade show {{ request('tab') == 'home' || request('tab') == null ? 'active' : '' }}"
